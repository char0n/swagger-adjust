# Contributing to swagger-adjust
...
* In GitHub, send a pull request to `swagger-adjust:main`.
...
we use the git commit messages to **generate the swagger-adjust change log**.
...
Samples: (even more [samples](https://github.com/char0n/swagger-adjust/commits/main))
...
If you want to reference an issue, but the commit doesn't close one use `Refs` keyword.
...
Thank you to all the people who have already contributed to swagger-adjust!
